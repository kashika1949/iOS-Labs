...
print("Initial position of \(destroyer.name): \(destroyer.position)")


destroyer.moveRight()

print("Position of \(destroyer.name) after moving right: \(destroyer.position)")
...
print("Error: 'falcon' is of type Spaceship which doesnt have a 'weapon' property. ")
...
destroyer.name = "Destroyer"
destroyer.weapon = "Laser"
destroyer.remainingFirePower = 4
