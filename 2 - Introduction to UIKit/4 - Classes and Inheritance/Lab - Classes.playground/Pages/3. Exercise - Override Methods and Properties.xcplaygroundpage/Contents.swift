...
class ShieldedShip: Fighter {
    ...
    override func wasHit() {
            if shieldStrength > 0 {
                shieldStrength -= 5
                print("\(name) was hit! Shield absorbed the damage. Shield strength: \(shieldStrength)")
            } else {
...
defender.moveRight()
print("Position of \(defender.name): \(defender.position)")


defender.fire()
print("Remaining firepower of \(defender.name): \(defender.remainingFirePower)")
...
print("Final Shield Strength is\(defender.shieldStrength)")
print("Final Health is \(defender.health)")
