 ...
 */
var walkingChallenges : [String] = ["Walk 3 miles a day", "Do 5 push-ups"]
var runningChallenges : [String] = ["Run 5 times a week", "Swim for 20 minutes"]
...
var challenges: [[String]] = [["Walk 3 miles a day", "Do 5 push-ups"], ["Run 5 times a week", "Swim for 20 minutes"]]
...
var userCommitChallenges : [String] = ["hello", "hello"]

//:  Write an if statement that will use `isEmpty` to check if there is anything in the array. If there is not, print a statement asking the user to commit to a challenge. Add an else-if statement that will print "The challenge you have chosen is <INSERT CHOSEN CHALLENGE>" if the array count is exactly 1. Then add an else statement that will print "You have chosen multiple challenges."
if userCommitChallenges.isEmpty {
    print("Commit a challenge")
}
else if userCommitChallenges.count == 1 {
    print("the challenge you have choosen is \(userCommitChallenges)")
}
else {
