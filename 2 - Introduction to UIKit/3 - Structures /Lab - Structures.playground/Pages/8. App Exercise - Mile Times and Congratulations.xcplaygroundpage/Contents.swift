...
var averageMileTime = RunningWorkout(distance: 1600, time: 60, elevation: 0)
print(averageMileTime.distance)
print(averageMileTime.time)
print(averageMileTime.elevation)
print("Average mile time: \(averageMileTime.distance / averageMileTime.time) seconds per mile")
