...
let favouriteBook = book(title:"The Three Musketeers " , author: "Alexandra", pages: 750, price: 380.0)
print ("My favourite book is \(favouriteBook.title) by \( favouriteBook.author) has pages \(favouriteBook.pages) and price is \( favouriteBook.price) ")
/*:
...
let l1 = laptop(screenSize: 15 , repairCount: 150 ,yearPurchased: 2020)
let l2 = laptop(screenSize: 20 , repairCount: 100 , yearPurchased: 2019 )
...
var myHeight = height(Centimeters: 177.8)
