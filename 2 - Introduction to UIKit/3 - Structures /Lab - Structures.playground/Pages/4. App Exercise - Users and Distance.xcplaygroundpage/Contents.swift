...
var Kashika = User(name: "Kashika", age: 20, height: 162, weight: 54, activityLevel: 7)
print("Hello, my name is \(Kashika.name) and I am \(Kashika.age) years old. Weight is \(Kashika.weight)kg  Height is \(Kashika.height)cm . My activity level is \(Kashika.activityLevel)/10")
/*:
