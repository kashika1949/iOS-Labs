...
let divisonResult : Double = double10 / double3
print (divisonResult)
...
let even : Int = 10
let odd : Int = 9
let evenRemainder = even % 2
let oddRemainder = odd % 2
print (" Even remainder : \(evenRemainder)")
print (" Odd remainder : \(oddRemainder)")  
