 ...
 */
var pennyBank: Int = 0
var neighborGift: Int = 10
var weeklyEarnings: Int = 20
var dinnerAndMovie: Int = pennyBank / 2
var windows: Int = (pennyBank - dinnerAndMovie) * 3
var convenienceStore: Int = 3

pennyBank += neighborGift
pennyBank += weeklyEarnings
pennyBank -= dinnerAndMovie
pennyBank = windows
pennyBank -= convenienceStore
