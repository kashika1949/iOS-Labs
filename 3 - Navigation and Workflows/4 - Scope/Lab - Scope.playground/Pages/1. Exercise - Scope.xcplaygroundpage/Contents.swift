...
print("because foo is not a globbal variable and is only defined in the scope of the for loop")
...
print("In this code  x is defined as a global scope wheras in previous code it is defined as local scope of the for loop ")
...
var myCar = Car(make: "Toyota", model: "Camry", year: 2024)
